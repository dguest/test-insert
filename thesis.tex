...
As no evidence of physics beyond the standard model is found, the search is used to set exclusions with $95\%$ confidence exclusions in the scalar charm vs neutrilino mass plane.
}
...
\bibliography{refs/general,refs/twiki,refs/objects,refs/theory,refs/detector,refs/searches,refs/simulation,refs/upgrade}
