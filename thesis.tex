...
As no evidence of physics beyond the standard model is found, the search is used to set exclusions with $95\%$ confidence in the scalar charm vs neutrilino mass plane.
}
