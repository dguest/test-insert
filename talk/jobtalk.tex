...
\begin{frame}
  \frametitle{How hard could training a NN be?}
  \begin{columns}
...
%% figures/tagging-graphs/tagging-leg.pdf}
  ...
  \end{columns}
  \begin{itemize}
  \item For a deep NN, it's really hard
  \item The ATLAS flavor tagging framework grew very complicated
  \end{itemize}
\end{frame}
