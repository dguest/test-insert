...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      ...
      \item Problem: Higgs Yukawa couplings give \emph{huge} corrections
...
\begin{frame}
  ...
  \item \textbf{Flavor-tagging relies on displaced vertices, can travel mm--cm}
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{The Calorimeter (Our ``Dark Matter'' Detector)}
...
\begin{frame}
  ...
  \begin{itemize}
  \item We only directly reconstruct $\cancelto{7}{6}$ ``particles''
  \end{itemize}
  \begin{columns}
    \begin{column}{0.35\textwidth}
      \begin{itemize}
      \item \textcolor{darkgreen}{\textbf{Some are easy}}
        \begin{itemize}
        \item $\mu$ spectrometer
        \item Calorimeter
        \end{itemize}
      \item \textcolor{red}{Some are hard}
        \begin{itemize}
        \item Vertexing
        %% \item Easily confused
        \end{itemize}
      \item \colorbox{aqua}{Many are indirect}
        \begin{itemize}
        \item $\met$
        \item Symmetries
        \end{itemize}
      %% \item Light jets ($u$, $d$, $s$) aren't distinguished
      \item \textcolor{orange}{\textbf{charm}} used to be a ``light'' quark, charm-tagging makes it heavy
      \end{itemize}
    \end{column}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \item $b$-tagging is easier: longer lifetime\\
        \begin{center}
          ...
          \end{tabular}
          $\langle L_{xy} \rangle \approx 6.4\,\mathrm{mm}$, $B$ @ $70\,\gev$
        \end{center}
...
figures/tagging-graphs/simple-nn_gen.pdf} \\
  ...
  \item Must be ``trained'' using labeled data
  %% \item Connections, thresholds initially random
