...
\begin{frame}
  ...
  \item In the simplest case, identical masses to SM
    ...
    \end{itemize}
  \item Clearly not physical $\to$ add \emph{soft} terms
  \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{The LHC}
  \begin{itemize}
  \item Mention that we have a lot of collisions
  \end{itemize}
\end{frame}
...
figures/tagging-graphs/simple-nn_gen.pdf} \\
  ...
  \item Edges (``synapses'') activate or suppress the nodes in following layer
  \end{itemize}
\end{frame}
