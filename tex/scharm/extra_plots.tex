...
\end{center}
\caption[$\met$ distribution in the \vrmct{} region]{$\met$ distribution in the \vrmct{} region. The region with $\met < 150~\gev$ isn't well described due to limitations in trigger efficiency.}
\label{fig:qcd-vra}
\end{figure}
