...
Following the anti-QCD cuts, the signal remains small relative to the SM backgrounds. As shown in \cref{fig:flavor-comp-presel}, the leading two jets in these two backgrounds are dominantly light flavored.
...
In some cases a non-$b$~jet has higher $\pt$ than one of the $b$~jets, which gives rise to two populations of $\ttbar$: $b$-lead $\ttbar$, where the leading two jets are $b$-jets, and non-$b$-lead where one of these jets is a $c$-tagged jet.
