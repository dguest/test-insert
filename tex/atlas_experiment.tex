...
The \atlas\ forward calorimeter covers the $3.1 < |\eta| < 4.9$ region, again with liquid-argon--based detectors~\cite{atlas-fcal}.
This region is especially saturated with minimum-bias events and demands both higher density and a faster drift time than the barrel and endcap calorimeters.
Each of the two forward calorimeters consists of three $45\,\mathrm{cm}$ copper modules with$\sim 5\,\mathrm{mm}$ diameter holes running along the beam axis.
...
This inner module is designed primarily for EM radiation and uses copper rods.
Rods in the remaining two modules are constructed from tungsten to absorb hadronic particles.
To further reduce punch-through, a copper alloy plug is positioned behind the third forward calorimeter module.
