...
The muon spectrometer is the single largest component in the \atlas\ detector.
...
These chambers contain three to eight layers of drift tubes similar to those in the TRT. A cross-section of a single drift-tube is shown in \cref{atlas-mdt-crosssection}.
...
In the region where $|\eta| > 2.0$ higher particle flux necessitates
