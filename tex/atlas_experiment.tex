...
By varying this road width, multiple muon triggers can thus be configured with various minimum $\pt$ thresholds.
...
As the decay products from the hard scatter separate strong interactions become more important.
Events are passed to routines which model the showers of colored particles as they coalesce into hadrons.
