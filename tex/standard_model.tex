...
\end{pmatrix}.
\end{equation}
This rough approximation form the conceptual core of flavor-tagging (discussed in \cref{sec:pheno}). It also highlights a more philosophical point; the CKM matrix doesn't \emph{need} to be approximately diagonal, it just \emph{is}. In general, there is no reason to believe a mixing matrix should have this structure\footnote{While neutrino mixing is completely ignored in this thesis, the far-from-diagonal structure of the neutrino mixing matrix gives this point more credibility.}. The implications of this argument are discussed in more detail in \cref{sec:supercharm}.
