...
\begin{table}
  ...
  \begin{center}
    \begin{tabular}{|c|c|c|c|c|} \hline
      ...
      \multirow{2}{*}{Higgs} & $H_u$ & $H^+_u$, $H^0_u$ & $\tilde{H}^+_u$, $\tilde{H}^0_u$ & --- \\
      & $H_d$ & $H^0_d$, $H^-_d$ & $\tilde{H}^0_d$, $\tilde{H}^-_d$ & --- \\ \hline
